package cochesfx.app.controlador;

import cochesfx.app.modelo.Coche;
import cochesfx.app.modelo.CocheDAO;
import cochesfx.util.AlertUtils;
...
//            lbEstado.setText("No se ha seleccionado ningún coche");
            AlertUtils.mostrarInfo("No se ha seleccionado ningún coche");
            return;
        }
...
//            lbEstado.setText("Coche eliminado con éxito");
            AlertUtils.mostrarInfo("Coche eliminado con éxito");
    ...
    public void guardarCoche(Event event) {
        ...
        try {
            ...
            AlertUtils.mostrarError("Error al guardar el coche");
        }
        
        AlertUtils.mostrarInfo("Coche guardado con éxito");
    ...
    public void exportar(ActionEvent event) {
        try {
            ...
            CSVPrinter printer = new CSVPrinter(fileWriter,
                    CSVFormat.DEFAULT.builder().setHeader("id", "matricula", "marca", "modelo", "tipo").build());
